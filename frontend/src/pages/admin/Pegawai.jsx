...
import { useDataPegawai } from "../../hooks/PengelolaHooks"

const Pegawai = () => {
    const {isLoading, data, isError, error} = useDataPegawai()
    ...
    return (
        <section className="px-4 py-4 lg:px-16 lg:py-8">
            ...
            <div className="bg-white px-4 py-4 mt-6 rounded-md shadow-md lg:px-8">
                <h1 className="font-semibold text-blue-500 lg:text-lg">Tabel Pegawai</h1>
                <p className="text-gray-500 text-sm lg:text-base">Berikut adalah tabel daftar pegawai di perusahaan</p>
                <div className="block">
                        ...
                        <table className="w-full text-sm text-left">
                            <thead className="bg-gray-200">
                                <tr>
                                    ...
                                    <th scope="col" className="px-6 py-2">Nama Pegawai</th>
                            ...
                            <tbody className="bg-gray-100">
                                {data?.data.data.map((row, index) => (
                                    <tr key={index}>
                                        ...
                                        <td className="px-6 py-2 font-semibold whitespace-nowrap">{row.nama_pegawai}</td>
